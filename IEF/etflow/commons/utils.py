...
def compute_edge_index(
    ...
    for bond in mol.GetBonds():
        ...
        edge_list_reverse.append((j, i))
        bond_types_reverse.append(bond_to_feature_vector(bond))
    
    if not no_reverse:
        edge_list += edge_list_reverse
        bond_types += bond_types_reverse
...
def _extend_to_radius_graph(
    ...
    # use sparse_coo_tensor instead of sparse.LongTensor
